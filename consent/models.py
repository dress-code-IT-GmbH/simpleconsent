...
class Consent(models.Model):
    ...
    uid = AutocutCharField(default='', max_length=UID_MAX_LENGTH, verbose_name='UserID')
    displayname = AutocutCharField(default='', max_length=SP_DISPLAYNAME_LENGTH)
    consentid = AutocutCharField(max_length=200)  # hash(userid + attribut set)
    entityID = AutocutCharField(null=False, max_length=1024, verbose_name='Identifier der Anwendung')
